...
public class CollectImpressionsReducer extends Reducer<Text, Text, Text, Text> {
	...
	public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
		...
		for (String k: hm.keySet()) {
			mos.write(new Text(key.toString() + "\t" + k), new Text("IMP" + "\t" + String.valueOf(hm.get(k))), key.toString() + "/part");
		}
	}
