...
public class CollectConversionsRunner extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "CollectConversions");
		job.setJarByClass(Class.forName(this.getClass().getName()));
		
		// Set Mapper
		job.setMapperClass(com.sharethis.adoptimization.conv.collection.CollectConversionsMapper.class);
		job.setMapOutputKeyClass(Text.class);
				
		// Set Reducer
		job.setReducerClass(com.sharethis.adoptimization.conv.collection.CollectConversionsReducer.class);
	...
	public static void main(String[] args) throws Exception {
		...
		CollectConversionsRunner runner = new CollectConversionsRunner();
