...
public class CTRTreeRunner extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "CTRTree");
		job.setJarByClass(Class.forName(this.getClass().getName()));
		
		// Set Mapper
		job.setMapperClass(com.sharethis.adoptimization.ctr.tree.CTRTreeMapper.class);
		job.setMapOutputKeyClass(Text.class);
				
		// Set Reducer
		job.setReducerClass(com.sharethis.adoptimization.ctr.tree.CTRTreeReducer.class);
		...
		String output_path = rf.get("CTRTreeOutputPath", "");
	...
	public static void main(String[] args) throws Exception {
		...
		CTRTreeRunner runner = new CTRTreeRunner();
